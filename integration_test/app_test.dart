...
void main(){
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();
    ...
    testWidgets('Integration Test', (tester) async{
      ...
      //Testando botão sair no drawer

      // Tocar no botão de abertura do Drawer
    ...
    //   await tester.pumpAndSettle();
    //
    //   // Aguardar a conclusão de tarefas assíncronas
    //   await tester.runAsync(() async {
    //     // Aguardar um curto período para permitir que o aplicativo feche
    //     await Future.delayed(Duration(seconds: 1));
    //
    //     // Verificar se o aplicativo está fechado
